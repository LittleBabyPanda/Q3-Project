...
ytyvar <- read.csv("Documents/Q3-Project/Ressources/yty.csv", sep=",")

ytyvar <- ytyvar$TOTAL[82:length(ytyvar$TOTAL)]
ytyvar <- c(ytyvar)

X_cvs <- ts(read.csv("Documents/Q3-Project/Ressources/inputdatacvs.csv"),frequency=12, start=c(2011,4))
X_brut <- ts(read.csv('Documents/Q3-Project/Ressources/inputdatabrut.csv'), frequency=12, start=c(2011,4))
